...
!define APPNAME "METAbolt"
!define VERSION "2.0"
!define MAINEXEC "${APPNAME}.exe"
!define DOTNET_VERSION "3.5"
!define VOICEPACK "METAboltVoicepack-1.0.exe"
...
LicenseText "Please review the license terms before installing METAbolt"
...
Section "${APPNAME} core (required)"
  ...
  WriteRegStr HKLM ${UNINST_REG} "Publisher" "METAbolt Development Team"
